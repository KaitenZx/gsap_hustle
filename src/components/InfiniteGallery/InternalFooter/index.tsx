...
export const InternalFooter: React.FC<InternalFooterProps> = ({
	isVisible,
}) => {
	...
	const footerLinks = useMemo(
		() => [
			{
				href: 'https://www.instagram.com/glitchypixels/',
				text: 'INSTAGRAM',
				iconComponent: InstagramIcon,
				ariaLabel: 'Instagram',
			},
			{
				href: 'https://x.com/iamglitchypixel',
				text: 'TWITTER',
				iconComponent: TwitterIcon,
				ariaLabel: 'Twitter',
			},
			{
				href: 'https://www.reddit.com/user/iamglitchypixels/',
				text: 'REDDIT',
				iconComponent: RedditIcon,
				ariaLabel: 'Reddit',
			},
			{
				href: 'https://thehug.xyz/artists/glitchypixels',
				text: 'THEHUG',
				iconComponent: TheHugIcon,
				ariaLabel: 'TheHug',
			},
			{
				href: 'mailto:iamglitchypixel@gmail.com',
				text: 'MAIL',
